...
namespace BackendTests
{
    internal class main
    {
        ...
        {
            ServiceFactory grading = new ServiceFactory();
            grading.DeleteData();
            grading.LoadData();

            grading.Register("asal@mail.mail", "Password1");
            grading.Login("mail@mail.mail", "Password1");
          
           


            //grading.AddBoard("guy@gmail.com", "sami");


            /*            grading.Register("sami@gmail.com", "Hatuka1234");
                        grading.Register("saaami@gmail.com", "Hatuka1234");
                        grading.AddBoard("sami@gmail.com", "boardi");
                        grading.AddTask("sami@gmail.com", "boardi", "hi", "bye", new DateTime(2024, 11, 11));
                        grading.JoinBoard("saaami@gmail.com", 1);
                        grading.AssignTask("sami@gmail.com", "boardi", 0, 0, "saaami@gmail.com");
                        grading.LeaveBoard("saaami@gmail.com", 1);
                        grading.AssignTask("sami@gmail.com", "boardi", 0, 0, "sami@gmail.com");
                        grading.UpdateTaskDescription("sami@gmail.com", "boardi", 0, 0, "newdesc");


                        grading.AssignTask("sami@gmail.com", "boardi", 0, 0, "sami@gmail.com");
                        grading.AssignTask("saaami@gmail.com", "boardi", 0, 0, "saaami@gmail.com");*/
            /*            grading.Register("sami@gmail.com", "Hatuka1234");
                        grading.AddBoard("sami@gmail.com", "boardi");
                        grading.AddTask("sami@gmail.com", "boardi", "hi", "bye", new DateTime(2024, 11, 11));
                        grading.Register("susu@gmail.com", "Sumo121111");
                        grading.JoinBoard("susu@gmail.com", 1);
                        grading.LeaveBoard("susu@gmail.com", 1);*/
            ...
            static void AddBoardTests(GradingService grading)
            {
                ...
                Console.WriteLine(grading.AddBoard("AddBoardTests1@email.com", "AddBoardTestsBoard"));
                Console.WriteLine(grading.JoinBoard("AddBoardTests1@email.com", 2));
            ...
            static void LimitColumnTests(GradingService grading)
            {
                ...
                // add too many tasks
                grading.AddTask("LimitColumnTests1@email.com", "LimitColumnTestsBoard", "task11", "desc11", new DateTime(2023, 7, 1));
                grading.AddTask("LimitColumnTests1@email.com", "LimitColumnTestsBoard", "task12", "desc12", new DateTime(2023, 7, 1));
                grading.AddTask("LimitColumnTests1@email.com", "LimitColumnTestsBoard", "task13", "desc13", new DateTime(2023, 7, 1));
                grading.AddTask("LimitColumnTests1@email.com", "LimitColumnTestsBoard", "task14", "desc14", new DateTime(2023, 7, 1));
                Console.WriteLine(grading.GetColumn("LimitColumnTests1@email.com", "LimitColumnTestsBoard", 0));
                Console.WriteLine(grading.AddTask("LimitColumnTests1@email.com", "LimitColumnTestsBoard", "task15", "desc15", new DateTime(2023, 7, 1)));
                Console.WriteLine(grading.GetColumn("LimitColumnTests1@email.com", "LimitColumnTestsBoard", 0));
            }
            ...
            static void GetColumnTests(GradingService grading)
            {
                ...
                grading.AssignTask("GetColumnTests1@email.com", "GetColumnTestsBoard", 0, 0, "GetColumnTests1@email.com");
                grading.AssignTask("GetColumnTests1@email.com", "GetColumnTestsBoard", 0, 1, "GetColumnTests1@email.com");
                grading.AssignTask("GetColumnTests1@email.com", "GetColumnTestsBoard", 0, 2, "GetColumnTests1@email.com");

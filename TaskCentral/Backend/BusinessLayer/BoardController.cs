...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    internal class BoardController
    {
        ...
        private BoardController()
        {
            // Private constructor to prevent instantiation from outside the class.
                    users = UserController.getInstance().UserDict;
    ...
    public static BoardController getInstance()
        ...
        private static readonly Dictionary<long, Board> boards = new Dictionary<long, Board>();
        ...
        public void LoadData()
        {
            ...
            foreach (BoardDTO b in boardlist)
            {
                ...
                {
                    User member = UserController.getInstance().UserDict[user.Members];
        ...
        public void limitCoulmn(string email, string boardName, int columnOrdinal, int limit)
        {
            ...
            long boardId = UserController.getInstance().getBoardByNameEmail(boardName, email).BoardId;
        ...
        public string GetColumnName(string email, string boardName, int columnOrdinal)
        {
            ...
            if (!boards.ContainsKey(UserController.getInstance().getBoardByNameEmail(boardName, email).BoardId))
            {
        ...
        public string AddTask(string email, string boardName, string title, string description, DateTime dueDate)
        {
            ...
            Board destinationBoard = UserController.getInstance().getBoardByNameEmail(boardName, email);
        ...
        public string AddBoard(string email, string name, int id, User owner)
        {
            ...
            UserController.getInstance().increaseIdCount();
        ...
        public string RemoveBoard(string email, string name)
        {
            ...
            long boardId = UserController.getInstance().getBoardByNameEmail(name, email).BoardId;
            ...
            Board boardToRemove = UserController.getInstance().getBoardByNameEmail(name, email);
        ...
        public void updateTaskDueDate(string email, string boardName, int columnOrdinal, int taskId, DateTime dueDate)
        {
            ...
            User user = UserController.getInstance().GetUser(email);
            if (!user.LoggedIn)
            {
            ...
            long boardId = UserController.getInstance().getBoardByNameEmail(boardName, email).BoardId;
            Board board = UserController.getInstance().GetUser(email).BoardList[boardId];

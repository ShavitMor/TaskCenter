...
+ @"((([\-\w]+\.)+[a-zA-Z]{2,4})|(([0-9]{1,3}\.){3}[0-9]{1,3}))$";
        ...
        {
            Board output = null;
            Dictionary<long, Board> boards = BoardController.getInstance().Boards;
        ...
        {
            return BoardController.getInstance().boardIdCounter;
        }

        internal void increaseIdCount()
        {
            BoardController.getInstance().increaseBoardIdCounter();
        }
        ...
        public void Delete()
        {
            BoardController.getInstance().Delete();
        ...
        public void LoadData()
        {
            ...
            BoardController.getInstance().LoadData();
        }
        ...
        public void LeaveBoard(string email, int boardID)
        {
            ...
            BoardController.getInstance().leaveBoard(email,boardID);
        ...
        public void TransferOwnership(string currentOwnerEmail, string newOwnerEmail, string boardName)
        {
            ...
            string[] keys = { "Id"};
            object[] vals = { boardId};
            BoardController.getInstance().BoardDal.Update(keys, vals, "OwnerEmail", newOwnerEmail);
        }
        ...
        public void AssignTask(string email, string boardName, int columnOrdinal, int taskID, string emailAssignee)
        {
            ...
            BoardController.getInstance().TaskDal.UpdateTask(keys, vals, "Assignee", assignee);
        }
